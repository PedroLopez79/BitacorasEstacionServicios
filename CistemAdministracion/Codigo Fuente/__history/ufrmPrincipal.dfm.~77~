  ...
  object dxBarManager1: TdxBarManager
    ...
    object tbReportes: TdxBar
      ...
      ItemLinks = <
        item
          Visible = True
          ItemName = 'btnReportesInventario'
        end
        item
          Visible = True
    ...
    object tbCatalogos: TdxBar
      ...
      ItemLinks = <
        ...
        item
          Visible = True
          ItemName = 'btnTipoValores'
        end
        item
          Visible = True
          ItemName = 'btnAlmacenes'
        end
        item
          Visible = True
          ItemName = 'btnBancos'
        ...
        item
          Visible = True
          ItemName = 'btnCuentasBancarias'
        end
        item
          Visible = True
          ItemName = 'btnConceptoSalidas'
        end
        item
          Visible = True
          ItemName = 'btnSalidas'
