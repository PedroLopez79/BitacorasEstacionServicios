...
type
  TfrmParametros = class(TdxCustomRibbonForm)
    ...
    procedure cmbSecuenciaFinLiquidacionEnter(Sender: TObject);
    procedure cxLookupComboBox1Enter(Sender: TObject);
    procedure CmbSecuenciaFinEnter(Sender: TObject);
...
begin
  inherited;
    ...
    If cxSecuencia.Visible=true then
    begin
       //Parametros.SecuenciaIni:=strtoint(txtSecuenciaIni.EditValue);
       Parametros.SecuenciaIni:=CmbSecuenciaIni.EditValue;
       //Parametros.SecuenciaFin:=strtoint(txtSecuenciaFin.EditValue);
       parametros.SecuenciaFin:=CmbSecuenciaFin.EditValue;
    end;
...
procedure TfrmParametros.CmbSecuenciaFinEnter(Sender: TObject);
begin
  inherited;
CargarSecuenciaIniFin;
end;

procedure TfrmParametros.cmbSecuenciaFinLiquidacionEnter(Sender: TObject);
begin
  inherited;
 CargarSecuenciaIniFin;
...
begin
  ...
  PrenderControl(cxSecuencia, Pos('D', Cad)>0);
