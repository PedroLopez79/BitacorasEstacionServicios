inherited frmPuntosDespachador: TfrmPuntosDespachador
  Caption = 'frmPuntosDespachador'
  ClientHeight = 551
  ClientWidth = 736
  OnShow = FormShow
  ExplicitTop = -111
  ...
  object pgcCatalogo: TcxPageControl
    ...
    object cxTabSheet7: TcxTabSheet
      ...
      object cxGroupBox1: TcxGroupBox
        ...
        object edtDespachadorID: TcxTextEdit
          Left = 84
          Top = 30
          TabOrder = 6
          OnEnter = edtDespachadorIDEnter
          OnExit = edtDespachadorIDExit
          OnKeyDown = edtDespachadorIDKeyDown
          Width = 50
        end
      ...
      object cxGrid2: TcxGrid
        ...
        object cxGridDBTableView1: TcxGridDBTableView
          ...
          object cxGridDBTableView1CARGO: TcxGridDBColumn
            DataBinding.FieldName = 'CARGO'
          end
          object cxGridDBTableView1ABONO: TcxGridDBColumn
    ...
    object cxTabSheet8: TcxTabSheet
      ...
      object cxGroupBox4: TcxGroupBox
        ...
        object cxTextEdit4: TcxTextEdit
          ...
          Top = 24
          TabOrder = 1
          OnEnter = cxTextEdit4Enter
          OnExit = cxTextEdit4Exit
      ...
      object cxGrid1: TcxGrid
        ...
        object cxGrid1DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.SummaryGroups = <>
          OptionsView.Footer = True
          object cxGrid1DBTableView1Canjear: TcxGridDBColumn
            DataBinding.FieldName = 'Canjear'
            PropertiesClassName = 'TcxCheckBoxProperties'
            Width = 85
          end
          object cxGrid1DBTableView1ArticuloID: TcxGridDBColumn
  ...
  object cdsSaldo: TDAMemDataTable
    ...
    LogicalName = 'spSaldosDespachador'
    IndexDefs = <>
    Left = 20
    Top = 411
  end
  ...
  object tblArticulos: TdxMemData
    Indexes = <>
    SortOptions = []
    Left = 536
    Top = 40
    object tblArticulosCanjear: TBooleanField
      FieldName = 'Canjear'
    end
    object tblArticulosArticuloID: TIntegerField
    ...
    object tblArticulosPuntos: TIntegerField
      FieldName = 'Puntos'
    end
  end
  ...
  object cdsObtenArticulos: TDACDSDataTable
    RemoteUpdatesOptions = []
    Fields = <
      item
        Name = 'ArticuloID'
    ...
    StreamingOptions = [soDisableEventsWhileStreaming]
    RemoteDataAdapter = DM.RemoteDataAdapter
    LogicalName = 'spObtenArticulos'
    IndexDefs = <>
    Left = 537
    Top = 71
  end
  object dsCliente: TDADataSource
    DataSet = cdsObtenArticulos.Dataset
    DataTable = cdsObtenArticulos
    Left = 568
    Top = 72
  end
  object cdsInsertarAbono: TDACDSDataTable
    RemoteUpdatesOptions = []
    Fields = <
      item
        Name = 'COLUMN1'
    ...
    StreamingOptions = [soDisableEventsWhileStreaming]
    RemoteDataAdapter = DM.RemoteDataAdapter
    LogicalName = 'spInsertaPuntosDesp'
    IndexDefs = <>
    Left = 538
    Top = 112
  end
  object cdsInsertaCompra: TDACDSDataTable
    RemoteUpdatesOptions = []
    Fields = <
      item
        Name = 'COLUMN1'
    ...
    StreamingOptions = [soDisableEventsWhileStreaming]
    RemoteDataAdapter = DM.RemoteDataAdapter
    LogicalName = 'spInsertaCompraPuntos'
    IndexDefs = <>
    Left = 569
    Top = 112
  end
